...
export function PayModal({ openedExit, setOpenedExit }: IExitModalProps) {
    ...
    async function criarConta(data: registerType) {
        ...
        try {
            ...
            const response: ApiRegisterResponse = await (
                await api.post("/cliente/registar", form)
            ).data;
            if (response.success) {
    ...
    async function verifyNif() {
        ...
        // }º
        try {
            const response: IEdgarResponse = await (
                await axios.get(
                    `https://consulta.edgarsingui.ao/public/consultar-por-nif/${nif}`
                )
            ).data;
        ...
        <>
            <Dialog open={openedExit}>
                <DialogContent className="sm:max-w-[425px] bg-white">
                    <DialogHeader>
                        <DialogTitle className="text-black">
                            ...
                            <span
                                ...
                                className="py-1.5 px-3 bg-red-50 text-red-600 font-[500] text-[0.9rem] mb-1 rounded-full ml-2"
                            >
                                Mais métodos brevemente
                            </span>
                        </DialogTitle>
                    ...
                    >
                        ...
                        <div className="w-1/2 items-center justify-start flex">
                            BAI Paga
                        </div>
                    </Button>
                    <Button
                    ...
                    >
                        ...
                        <div className="w-1/2 items-center justify-start flex  text-[#F78200]">
                        {iFrameLoading ? (
                                <TailSpin color="#F78200" width={40} strokeWidth={100} />
                            ) : (
                                <> MULTICAIXA Express</>
                            )}
            ...
            <Dialog open={openTrans}>
                <DialogContent className="sm:max-w-[425px] bg-white">
                    ...
                    <div className="flex gap-2  justify-center items-center">
                        ...
                        <Button
                            variant={"outline"}
                            onClick={() => setSelectedBanc(2)}
                            className="banc w-1/2 h-[50px] items-center justify-center p-0"
                            data-selected={selectedBanc === 2}
                        >
                            <img
                                src={atl}
                                className="w-[120px]"
                    ...
                    <div>
                        <div className="mt-2 w-full">
                            ...
                            <input
                                ...
                                value={
                                    selectedBanc === 1
                                        ? "0055 0000 3795 7135 1010 3"
                                        : "0055 0000 3795 7135 1010 3"
                                }
                                className="w-full text-center h-[30px] rounded-[12px] bg-white border-solid px-4"
                            />
                        </div>
                        <div className="mt-2 w-full">
                            <label
                        ...
                        <div className="mt-2 w-full">
                            ...
                            <input
                                type="text"
                                disabled
                                value="ANGOHOST PRESTACAO DE SERVICO LDA"
                                className="w-full mb-3 text-center h-[30px] rounded-[12px] bg-white border-solid px-4"
                            />
                        </div>
                    </div>
                    <div className="flex gap-2 items-center justify-center">
                        <Button
                            ...
                            className="w-1/2 items-center justify-center p-0"
                        >
                            Cancelar
                        </Button>
                        <Button
                            ...
                            onClick={pay}
                            variant={"default"}
                            className="w-1/2 bg-zinc-900 hover:bg-zinc-900 items-center justify-center p-0"
                        >
                            {loading ? (
                ...
                <DialogContent className="sm:max-w-[425px] bg-white">
                    ...
                    <div className="flex gap-2">
                        <Button
                            ...
                            className="banc w-1/2 items-center justify-center p-0"
                            data-selected={signMode === 1}
                        >
                            Criar conta
                        </Button>
                        <Button
                            variant={"outline"}
                            onClick={() => setSignMode(2)}
                            className="banc w-1/2 items-center justify-center p-0"
                            data-selected={signMode === 2}
                        >
                            Entrar
                        </Button>
                    </div>
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <Input
                                        ...
                                        className="inputVerifyDomain w-full"
                                    />
                                </div>
                                <div className="w-full flex items-center justify-center gap-2 mt-2">
                                    ...
                                    <Button
                                        type="button"
                                        onClick={verifyNif}
                                        disabled={nif.length < 10}
                                        className="w-1/2 bg-[var(--primary)] hover:bg-[var(--primary)] flex items*center justify-center gap-2"
                                    >
                                        {loadingVerify ? (
                                            <TailSpin color="#fff" width={20} />
                                        ) : (
                    ...
                    {signMode === 2 && (
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <Input
                                        placeholder="(+244) 9012345678"
                                        {...register("clientRef")}
                                        className="inputVerifyDomain w-full mb-2"
                                    />
                                </div>
                                <Label
                                    htmlFor="username"
            ...
            <Dialog open={openCreateAccount}>
                <DialogContent className="sm:max-w-[425px] bg-white">
                    ...
                    <form
                        onSubmit={registerSubmit(criarConta)}
                        className="flex flex-col gap-2"
                    >
                        <div>
                            ...
                            <div className="flex gap-2">
                                <Input
                                    type="text"
                                    {...registerRegister("endereco")}
                                    placeholder="Av. Pedro de Castror, rua A2"
                                    className="inputVerifyDomain w-full"
                                />
                            </div>
                            <Label
                            ...
                            <div className="w-full flex items-center justify-center gap-2 mt-3">
                                ...
                                <Button
                                    ...
                                    disabled={
                                        ...
                                        !!registerErrors.endereco ||
                                        !!registerErrors.reSenha ||
