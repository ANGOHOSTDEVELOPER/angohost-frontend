...
const EmailPagePlano = () => {
    ...
    return (
        <>
            <Helmet>
                <title>
                    E-mail Corporativo - Aumente a credibilidade da sua empresa
                </title>
                <h1>
                    E-mail Corporativo - Aumente a credibilidade da sua empresa
                </h1>
                    ...
                    <div className="container-hospedagem-wordpress">
                        <div className="content-hospedagem-wordpress-left">
                            <div className="content-info">
                                <h3>E-mail</h3>
                                <h2>
                                    Crie Seu Email Profissional com a Angohost!
                                </h2>
                                <p>
                                    <strong>
                                        Credibilidade e Confiabilidade
                                    </strong>
                                    , Tenha um endereço de email personalizado
                                    que inspira confiança.
                                </p>
                            </div>
                            <div className="planos-button-flex">
                                <Link
                                    to={"/hospedagem-de-sites"}
            ...
            <div className="plano-title">
                <h2>
                    Garanta já o seu email profissional e destaque-se no
                    mercado!
                </h2>
                    ...
                    <CarouselContent   className="w-full flex justify-center">
                        {emailPlans &&
                            emailPlans.map((plan, index) => (
                                <CarouselItem key={plan.id} className="md:basis-1/2 lg:basis-1/5" >
                                    <PricingCard
                                        key={index}
                                        cicle={"Anual"}
                                        descontos={0}
                                        ...
                                        planoPopular={false}
                                        preco={plan.preco}
                                        precoComDesconto={plan.preco - 1000}
                                        link={() => openModal(index)}
                                        recursos={
                                            plan.recursos ? plan.recursos : []
                                        }
                                        titulo={plan.tipo}
                                        info={"lorem ipsum dolor teste beta"}
                                    />
                                </CarouselItem>
                            ))}
                    </CarouselContent>
            ...
            <RejectModal
                ...
                setOpenedReject={setOpendedReject}
            />
        </>
    );
};
