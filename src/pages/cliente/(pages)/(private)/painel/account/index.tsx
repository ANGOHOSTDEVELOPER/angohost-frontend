...
export default function AccountView() {
    ...
    const {saldo}= storeCreditoCliente()
    const {formatMoney}=useUtils()
    const {onCloseAnOpenModalCredito}=storeModalCreditoModalGpo()
    ...
    return (
        ...
        <>
            <div className="w-full h-full pb-6 px-3">
                ...
                >
                    <div
                        className="flex-[1] h-full bg-white rounded-[20px] border-solid border-[1px] flex items-start flex-col justify-start">
                        <div className="w-full h-[130px] border-b-[1px] flex border-b-solid">
                            <div className="w-max h-full flex items-center justify-center px-6">
                                <div
                                    className="w-[80px] h-[80px] rounded-full bg-zinc-100 flex items-center justify-center">
                    ...
                    <div className="w-[400px] h-full bg-white rounded-[29px] border-solid border-[1px] p-6">
                        <div className="border-solid border-[1px] rounded-[20px] w-full h-max px-3 p-3">
                            <div className="flex items-center justify-between">
                                ...
                                <span
                                    className="bg-red-100 px-3 text-red-600 pointer-events-none text-[0.8rem] rounded-full py-2">
                                Brevemente
                            </span>
                            </div>
                        ...
                        <div
                            className="border-solid border-[1px] border-red-200 rounded-[20px] w-full mt-4 h-max px-3 p-3 bg-red-50">
                            <div className="flex items-center justify-between">
                                <h1
                    ...
                    <div
                        className="w-[400px] h-full bg-white rounded-[29px] border-solid border-[1px] p-5 overflow-y-scroll">
                        <div className="border-solid border-[1px] rounded-[20px] w-full h-max px-3 p-3">
                            <div className="flex items-center justify-between">
                                <h1
                                    className="text-[#2e2e2e] pointer-events-none font-[500] text-[1rem] font-[Rubik]"
                                ...
                                <span
                                    className="bg-green-100 px-3 text-green-600 pointer-events-none text-[0.8rem] rounded-full py-2">
                                Disponivel
                            </span>
                            </div>
                            <div className="mt-2 flex items-start flex-col justify-start">
                            ...
                            <div className="w-full gap-3 mt-6 flex items-center justify-center">
                                <button
                                    onClick={()=>onCloseAnOpenModalCredito(true)}
